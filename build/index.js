...
const resolvers = {
  ...
  Mutation: {
    ...
    deleteUser: (parent, {
      ...
      const deleteUsers = _db__WEBPACK_IMPORTED_MODULE_0__["users"].slice(userIndex, 1);
